...
// CODE HERE
const last = (arr, callback) => callback(names[6])
...
each(names, (item, index) => console.log(`This item at index ${index} is ${item}.`))
...
let addSixtyThree = addingFactory(63)
console.log(addSixtyThree(6))
